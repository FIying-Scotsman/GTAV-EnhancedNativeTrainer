...
const std::vector<VehicleImage> INGAME_VEH_IMAGES =
{
	...
	{ RAGE_JOAAT("DRIFTYOSEMITE"), "sssa_dlc_xmas2017", "yosemite" }, // Reuses base YOSEMITE's real picture - VP_YOSEMITE was just the base name reused on an unconfirmed ENT_vehicle_previews.ytd texture.
	{ RAGE_JOAAT("DRIFTFR36"), "sssa_dlc_2023_2", "fr36" },//
	{ RAGE_JOAAT("DRIFTEUROS"), "lgm_dlc_tuner", "euros" }, // Reuses base EUROS's real picture - see DRIFTYOSEMITE above for why.
	{ RAGE_JOAAT("DRIFTREMUS"), "sssa_dlc_tuner", "remus" }, // Reuses base REMUS's real picture - see DRIFTYOSEMITE above for why.
	{ RAGE_JOAAT("DRIFTZR350"), "lgm_dlc_tuner", "zr350" }, // Reuses base ZR350's real picture - see DRIFTYOSEMITE above for why.
	{ RAGE_JOAAT("DRIFTTAMPA"), "sssa_dlc_christmas_3", "tampa" }, // Reuses base TAMPA's real picture - see DRIFTYOSEMITE above for why.
	{ RAGE_JOAAT("DRIFTJESTER"), "lgm_dlc_business", "jester" }, // Reuses base JESTER's real picture - see DRIFTYOSEMITE above for why.
	...
	{ RAGE_JOAAT("DRIFTVORSCHLAG"), "sssa_dlc_2024_1", "vorschlag" }, // Reuses base VORSCHLAG's real picture - see DRIFTYOSEMITE above for why.
	{ RAGE_JOAAT("VORSCHLAGHAMMER"), "sssa_dlc_2024_1", "vorschlag" }, // No picture of its own available - reuses the base VORSCHLAG's as the closest available match.
	{ RAGE_JOAAT("DRIFTNEBULA"), "sssa_dlc_vinewood", "nebula" }, // Reuses base NEBULA's real picture - see DRIFTYOSEMITE above for why.
	{ RAGE_JOAAT("DRIFTCYPHER"), "lgm_dlc_tuner", "cypher" }, // Reuses base CYPHER's real picture - see DRIFTYOSEMITE above for why.
	//Xmas 2024 - FIB DLC
	...
	{ RAGE_JOAAT("DRIFTCHEBUREK"), "sssa_dlc_assault", "cheburek" }, // Reuses base CHEBUREK's real picture - see DRIFTYOSEMITE above for why.
	...
	{ RAGE_JOAAT("DRIFTFUTO2"), "sssa_dlc_tuner", "futo2" }, // Reuses base FUTO2's real picture - VP_FUTO was missing the "2", likely showing the wrong generation's picture.
	...
	{ RAGE_JOAAT("DRIFTGAUNTLET4"), "sssa_dlc_vinewood", "gauntlet4" }, // Reuses GAUNTLET4's own picture - VP_GAUNTLETHELLFIRE was a guess (see the two abandoned POPGAUNTLET/GAUNTLET5 attempts above) never confirmed to actually exist in ENT_vehicle_previews.ytd, and confirmed broken in-game.
	{ RAGE_JOAAT("DRIFTDOMINATOR10"), "sssa_dlc_2024_1", "dominator10" }, // Reuses base DOMINATOR10's real picture - VP_DOMINATORFX was also being reused for POLDOMINATOR10 elsewhere in this table, a sign it was never a variant-specific texture to begin with.
	...
	{ RAGE_JOAAT("DRIFTDOMINATOR8"), "sssa_dlc_tuner", "dominator8" }, // Reuses base DOMINATOR8's real picture - this had no image name at all before.
	{ RAGE_JOAAT("DRIFTCOQUETTE"), "lgm_default", "coquette" }, // Reuses base COQUETTE's real picture - this had no image name at all before.
	{ RAGE_JOAAT("DRIFTELEGY"), "lsc_dlc_import_export", "elegy_a" }, // Reuses base ELEGY's real picture - this had no image name at all before.
};
