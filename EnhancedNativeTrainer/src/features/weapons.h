...
const std::vector<std::string> CAPTIONS_TINT_MK2{ "Classic Black", "Classic Gray", "Classic Two-Tone", "Classic White", "Classic Beige", "Classic Green", "Classic Blue", "Classic Earth", "Classic Brown & Black", "Red Contrast", "Blue Contrast", "Yellow Contrast", "Orange Contrast", "Bold Pink", "Bold Purple & Yellow", "Bold Orange", "Bold Green & Purple", "Bold Red Features", "Bold Cyan Features", "Bold Yellow Features", "Bold Red & White", "Bold Blue & White", "Metallic Gold", "Metallic Platinum", "Metallic Gray & Lilca", "Metallic Purple & Lime", "Metallic Red", "Metallic Green", "Metallic Blue", "Metallic White & Aqua", "Metallic Red & Yellow" };
...
/*Gun Running DLC*/
const std::vector<std::string> CAPTIONS_ATTACH_PISTOLMK2{ "Default Clip", "Extended Clip", "Tracer Rounds", "Incendiary Rounds", "Hollow Point Rounds", "Full-Metal Jacket Rounds", "Componnent Rail", "Flashlight", "Suppressor", "Extended Muzzle", "Digital Camo", "Zebra Camo", "Green Camo", "Skull Camo", "Diamond Camo", "Designer Camo", "Zebra Camo 2", "White Tiger Camo", "Urban Camo", "Boom! Camo", "Independance Day Camo" };
...
/*Doomsday Heist*/
const std::vector<std::string> CAPTIONS_ATTACH_SNSPISTOLMK2{ "Default Clip", "Extended Clip", "Tracer Rounds", "Incendiary Rounds", "Armour Piercing Rounds", "Full-Metal Jacket Rounds", "Flashlight", "Componnent Rail", "Suppressor", "Flash Hider", "Digital Camo", "Zebra Camo", "Green Camo", "Skull Camo", "Diamond Camo", "Designer Camo", "Zebra Camo 2", "White Tiger Camo", "Urban Camo", "Boom! Camo", "Independance Day Camo" };
